...
if ($this->checkWeb()) {
    ...
    $data[] = array(
        ...
        'params' => array(
            ...
            array('name' => 'unaicid', 'type' => 'string', 'need' => true, 'desc' => 'unaicid'),
        ),
        'return' => array(
            ...
            array('name' => 'couponid', 'desc' => '优惠券ID'),
            array('name' => 'coupon_amount', 'desc' => '优惠券金额'),
            array('name' => 'addfee', 'desc' => '加价金额'),
            array('name' => 'goods_insurancemoney', 'desc' => '商品保价金额'),
