...
//         // alert("phone");
//         // window.location.href="https://www.uupt.com/mobile/index.html"
//       } else {
//         // alert("pc");
//       }
//     }
...
// browserRedirect();
console.log("%c", "background: url(https://www.uupt.com/images/logo_re.png) no-repeat center;padding-left:220px;padding-bottom:40px;line-height:100px;")
console.log("%c \n 加入UU跑腿，你的人生可以更精彩! -- UUPT前端团队\n %c请将简历发至 %c 896226896@qq.com %c（ 邮件标题请以“姓名-应聘XX职位-来自console”命名）", 'color:#1a1a1a', 'color:#1a1a1a', 'color:#ff8b03', 'color:#1a1a1a')
//开始坐标
var coordinatesS = [];
//结束坐标
var coordinatesE = [];
...
$(function () {
    ...
    $('.select-city').bind("click", function () {
        ...
        cityList();
        $('.high').each(function(){
            $(this).find('.letter').css({'height':$(this).find('.city_list ul').css('height'),'line-height':$(this).find('.city_list').css('height')});
        })
    });
